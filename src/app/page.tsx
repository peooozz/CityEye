    ...
    <div className="relative min-h-screen w-full bg-[#FAF9F6] text-[#192837] overflow-x-hidden selection:bg-[#7342E2] selection:text-white font-body">
      ...
      <main className="relative z-10 max-w-[1240px] mx-auto px-4 sm:px-6 pt-10 pb-20 flex flex-col items-center text-center">
        ...
        >
          ...
          <span className="font-mono-data text-red-600 font-bold">HACKATHON PROTOTYPE</span>
          <span className="text-black/30">|</span>
          <span className="text-[#5A6B7C]">Two-Stage YOLOv8 + VGG16 Helmet Detection Engine</span>
        </motion.div>
        ...
        >
          ...
          Violation Detection &amp; Automated E-Challans
        </motion.h1>
        ...
        >
          End-to-end deep learning architecture inspired by <strong>ThanhSan97</strong>. Uses <strong>YOLOv8</strong> to localize motorcycles &amp; riders, <strong>VGG16</strong> to classify upper head ROI crops, and <strong>ANPR OCR</strong> to issue instant Section 194D traffic fines.
        </motion.p>
        ...
        >
          <Link href="/feeds">
            ...
            >
              <span>Launch Live Helmet Stream</span>
              <ArrowRight size={16} />
            </motion.button>
          </Link>
          ...
          <Link href="/incidents">
            ...
            >
              ...
              <span>Non-Helmet Triage &amp; Fines</span>
            </motion.button>
          </Link>
        </motion.div>
        ...
        >
          <div className="flex items-start gap-3 p-3 rounded-2xl bg-white/50 border border-white/60">
            ...
            <div>
              <h4 className="text-xs font-bold text-[#192837]">Stage 1: YOLOv8</h4>
              <p className="text-[11px] text-[#5A6B7C] mt-0.5">Real-time motorcycle and rider localization</p>
            </div>
          </div>

          <div className="flex items-start gap-3 p-3 rounded-2xl bg-white/50 border border-white/60">
            <div className="p-2 rounded-xl bg-[#7342E2]/15 text-[#7342E2]">
              <Cpu size={18} />
            </div>
            <div>
              <h4 className="text-xs font-bold text-[#192837]">Stage 2: VGG16</h4>
              <p className="text-[11px] text-[#5A6B7C] mt-0.5">Head-crop Without-Helmet binary classification (97.4%)</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3 p-3 rounded-2xl bg-white/50 border border-white/60">
            ...
            <div>
              <h4 className="text-xs font-bold text-[#192837]">Stage 3: ANPR OCR</h4>
              <p className="text-[11px] text-[#5A6B7C] mt-0.5">Automatic license plate character recognition</p>
            </div>
          </div>
        </motion.div>
      </main>
